<template>
  <div>
    ...
    <el-dialog v-dialogDrag append-to-body :title="title" :visible.sync="open" width="800px">
      <el-row>
      ...
      this.$refs.cropper.getCropBlob(data => {
        ...
        uploadFile(formData).then(response => {
          if (response.code == 200) {
            this.open = false;
            this.options.img = getFileUrl(response.url);
            formData = new FormData();
            formData.append('avatar',response.url);
