<template>
  <div class="app-container">
    ...
    <!-- 添加或修改菜单对话框 -->
    <el-dialog v-dialogDrag append-to-body :title="title" :visible.sync="open" width="600px"  :close-on-click-modal=false>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType != 'M'" label="扩展Url">
              <el-input v-model="form.extUrl" placeholder="请输入扩展Url" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
